...
public class DataProvider {
    ...
    private static List<Beruang> initDataBeruang(Context ctx) {
        ...
        beruangs.add(new Beruang("Beruang Hitam Amerika", "Amerika",
                "sesuai namanya,beruang hitam amerika ini hidup di negara amerika.", R.drawable.hitam));
        beruangs.add(new Beruang("Beruang andes", "amerika ",
                "Mungk9n tuk jenis ini beruang satu ini masih belum pamiliar karena memang jarang sekali terekspos.", R.drawable.andes));
        beruangs.add(new Beruang("Beruang coklat", "Amerika utara",
                "jenis beruang satu ini menjadi spesies yang paling terkenal,dan untuk habitan asli dari beruang sama dengan beruang hitam ", R.drawable.coklat));
        beruangs.add(new Beruang("Beruang hitam asia", "Aasia",
                "Beruang hitam asia ini memiliki corak warna coklat yang menjadi khas dibagian dada yuang mana corak ini tidak akan di temui di beruang hitam amerika", R.drawable.hitamasia));
        beruangs.add(new Beruang("Beruang kutub", "Kutub utara",
                "sesuai namanya ,beruang kutub ini memiliki habitat asli di daerah kutub,tepatnya di kutub utara,hewan ini merupakan hewan karnipora dan mangsanya anjing laut", R.drawable.kutub));
        return beruangs;
    }
